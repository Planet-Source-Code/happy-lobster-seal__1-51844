...
program_finished:
        ...
        'Alert user program has finished
        If StepMode Then
            MsgBox "Execution Sucessful", vbInformation
            StepMode = False
        End If
...
Public Sub rtbOutput_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    Case vbKeyBack
        ...
        If KeyCode <> 0 Then frmAnimate.DoBackspace
    Case vbKeyControl
...
Public Sub AddCharacter(ByVal strChar As String)
    ...
    If frmAnimate.txtKeyboard.Locked = False Then
        SetCursorPosAndColour
        rtbOutput.SelText = strChar
    End If
End Sub
